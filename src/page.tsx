...
import { Mail, Star, Users, ArrowRight, ArrowLeft, FileText, Settings, BarChart, TrendingUp, Target, Zap } from 'lucide-react'
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500 dark:text-gray-400">© 2024 EmailThemes. All rights reserved.</p>
